...
<img src="https://readme-typing-svg.demolab.com?font=Poppins&weight=600&size=26&duration=3500&pause=1200&color=00C8FF&center=true&vCenter=true&width=900&lines=Full-Stack+Developer;AI+Engineer;Building+Production-Ready+Applications;Passionate+about+AI+%26+Modern+Web+Development;Open+to+Software+Engineering+Opportunities" />
...
I enjoy transforming ideas into production-ready applications using modern web technologies and Artificial Intelligence. My experience includes delivering real-world client projects, developing LLM-powered applications, and publishing research in AI.

- Freelance Full-Stack Developer at **Astruxio**
- Exploring **Agentic AI**, **LangChain**, **RAG**, and **MCP**
- Learning **Cloud Computing**, **Next.js**, and **System Design**
...
- Built and deployed production-ready web applications for clients.
- Developed responsive frontends and scalable backend services.
- Integrated Firebase, Supabase, payment gateways, authentication, and AI APIs.
- Managed deployments using Vercel and modern cloud platforms.
...
## 📝 EmpowHer – A Multimodal Digital Guardian for Women's Safety
